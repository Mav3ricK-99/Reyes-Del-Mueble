...
<head>  
	...
	<meta charset="UTF-8">
    <title>Decoracion - Reyes del Mueble</title>
    
</head>
<body>       
    <?php include 'includes/header.php'; ?>
    <section id="section1">
        <div class="toph2"><h2>Decoracion</h2></div>
        ...
        {?> 
            ...
            if($pagina!=1){$d=$pagina-1;echo "<li><a href='decoracion.php?pagina=".$d."'><button class='prev' title='Pagina anterior'>&#10094;</button></a></li>";}
            ...
            for ($i=1;$i<=$total_paginas;$i++)
            {
                ...
                {
                    echo "<li><a href='decoracion.php?pagina=".$i."'><button title='Pagina  ".$i."'>".$i."</button></a></li>"; 
                }
            }
            if($pagina!=$total_paginas){$d=$pagina+1;echo "<li><a href='decoracion.php?pagina=".$d."'> <button class='next title='Pagina siguiente'>&#10095;</button></a></li>";}
